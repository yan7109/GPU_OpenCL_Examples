...
//*****************************************************************
//! Exported Host/C++ RGB Average gradient magnitude function
...
//*****************************************************************
extern "C" double AverageFilterHost(unsigned int* uiInputImage, unsigned int* uiOutputImage, unsigned int uiWidth, unsigned int uiHeight, int fThresh)
{
    // start computation timer
    shrDeltaT(0);

	// do the Average magnitude with thresholding 
